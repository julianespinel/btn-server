...
CREATE TABLE relatives (id VARCHAR(128) PRIMARY KEY, name VARCHAR(128) NOT NULL, last_name VARCHAR(128) NOT NULL, email VARCHAR(128), cellphone BIGINT DEFAULT 0, relationship VARCHAR(128));
